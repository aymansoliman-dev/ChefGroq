...
export default function Submission({ ingredientsLength, isLoading }) {
    ...
    if (ingredientsLength < 4) submitBtnClassName = "bg-gray-100 text-[dimgray] cursor-not-allowed shrink-0 px-4 py-2 rounded-md active:scale-[0.98] transition ease-in duration-150 border-2 border-gray-300"
    else submitBtnClassName = "shrink-0 cursor-pointer border-2 border-dashed bg-white text-[#d17557] px-4 py-2 rounded-md active:scale-[0.98] transition ease-in duration-150"
